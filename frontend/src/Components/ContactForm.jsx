    ...
    <>
      ...
      <section data-aos="fade-up">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          <h2 className="mb-4 text-4xl tracking-tight  text-center text-gray-200">
            {t("contactUs.title")}
          </h2>
          <p className="mb-8 lg:mb-16 font-light text-center text-gray-400 text-lg sm:text-xl">
            {t("contactUs.text")}
          </p>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder={t("contactUs.subject.field")}
                required
              />
            </div>
            <div className="sm:col-span-2">
              ...
              <textarea
                ...
                placeholder={t("contactUs.message.field")}
              ></textarea>
            </div>
            <button
              type="submit"
